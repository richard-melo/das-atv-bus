...
public class ServiceBusClientConfiguration {
    ...
    private static final String SUBSCRIPTION_NAME = "subsrichard";
    private static final String QUEUE_NAME = "queue-richard";
    ...
    @Bean(name = "topicProcessorClient")
    ...
    @Bean(name = "queueProcessorClient")
